...
export const WORKSPACES_TABLE_ID = process.env.NEXT_PUBLIC_APPWRITE_WORKSPACES_ID as string;
export const MEMBERS_TABLE_ID = process.env.NEXT_PUBLIC_APPWRITE_MEMBERS_ID as string;
...
export const STORAGE_BUCKET_ID = process.env.NEXT_PUBLIC_APPWRITE_IMAGES_BUCKET_ID as string;
